...
namespace Server.Items
{
        ...
        */
        ...
        public static void GenerateLoserSashes(ArenaTeam loser, string tournyName)
        {
            ...
            foreach (Mobile mob in loser.Fighters)
            {
                ...
                sash.Name = String.Format("Participant of {0} Tournament - {1}", tournyName, DateTime.Now.ToShortDateString());
        ...
        public static void GenerateSponsorReward(Mobile winner, Tournament tourney)
        {
            ...
            {
                string str = String.Format("{0} has been chosen as the most valuable sponsor of the {1} Tournament! Please give {2} a round of applause.", winner.Name, tourney.Name, winner.Female ? "her" : "him");
                ...
                clothing.Name = String.Format("{0}, The Official Sponsor of the {1} Tournament", winner.Name, tourney.Name);
    ...
    public class TournamentTrophy : Item
    {
            ...
            : base(Utility.Random(0x139A, 4))
        {
            ...
            Name = String.Format("{0} PVP Tournament: {1} Place", tourney, placing == 1 ? "1st" : "2nd");
        }

        public override void GetProperties(ObjectPropertyList list)
        {
            base.GetProperties(list);
            list.Add(1060659, "{0}\t{1}", "Team", m_TeamName);
            int cliloc = 1060660;
