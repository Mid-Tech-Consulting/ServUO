...
namespace Server.TournamentSystem
{
    public static class Setup
    {
        ...
        {
            CommandSystem.Register("SetupPVPTournamentSystem", AccessLevel.Administrator, SetupGump);
        }
    ...
    public class SystemSetupGump : BaseTournamentGump
    {
        ...
        public override void AddGumpLayout()
        {
            ...
            AddHtml(37, 140, 350, 20, String.Format("Haven Island Arena (Trammel) {0}", ArenaHelper.HasArena<HavenArena>() ? "<basefont color=green>[Setup]" : "<basefont color=red>[Not Setup]"), false, false);
