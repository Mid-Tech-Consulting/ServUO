            ...
            protected override void OnTarget(Mobile from, object target)
            {
                if (target is Mobile)
                {
                    ...
                    if (mob is PlayerMobile && mob.Alive)
                    {
                        ...
                        else if (Team.Fighters.Contains(mob))
                ...
                case 1:
                    {
                        ...
                        else
                        {
                            ...
                            if (Offerer.HasGump(typeof(MyTeamStatsGump)))
                                Offerer.CloseGump(typeof(MyTeamStatsGump));
                            
                            if (!TeamExists)
                                BaseGump.SendGump(new RegisterTeamGump(Offerer, Team, System));
                            else
                                BaseGump.SendGump(new MyTeamStatsGump(Offerer, ArenaTeam.GetTeams(Offerer)));
                        }
                        break;
                    }
                case 2:
