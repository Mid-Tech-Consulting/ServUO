        ...
        private string m_TournamentInfo2
        {
            get
            {
                return "<br><B>Fight Teams - </B>In order to be eligable to participate in arena fights or tournaments, you " +
                       ...
                       "  <u>Bracketed</u> - Designed to give a pass to those with pre-fight jitters. Losers of round one will all fight in round two, where only those winners can continue on.<br>" +
