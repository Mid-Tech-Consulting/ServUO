...
namespace Server.TournamentSystem
{
        ...
        public override void AddGumpLayout()
        {
            ...
            else
            {
                ...
                for (int i = 0; i < UseList.Count; ++i)
                {
                    ...
                    if (Cooldown == null || !Cooldown.ContainsKey(User) || User.AccessLevel > AccessLevel.Player)
                    {
    ...
    public class TournamentInfoGump : BaseTournamentGump
    {
        ...
        public override void AddGumpLayout()
        {
            ...
            if (System.CurrentTournament != Tournament && User.AccessLevel > AccessLevel.Counselor)
            {
        ...
        public override void OnResponse(RelayInfo button)
        {
            switch (button.ButtonID)
            {
                ...
                case 3:
                    {
                        if ((User == Tournament.Creator && Tournament.Participants.Count == 0) || User.AccessLevel > AccessLevel.Player)
                ...
                case 6:
                    {
                        if (User.AccessLevel > AccessLevel.Counselor)
                        {
                            ...
                            for(int i = 0; i < Config.MinEntries; i++)
                            {
