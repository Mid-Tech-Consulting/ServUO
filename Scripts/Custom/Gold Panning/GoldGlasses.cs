...
{
	public class GoldGlasses : ElvenGlasses
	{
		...
		public GoldGlasses()
		{
			Name = "<BASEFONT COLOR=#A335EE>Gold Glasses [GAMMA]</font>";
			WeaponAttributes.HitHarm = 25;
			Attributes.BonusStr = 5;
			Hue = 18;

			int val = Utility.RandomList(5,10,15,20);
		...
		public GoldGlasses( Serial serial ) : base( serial )
		{
		}
