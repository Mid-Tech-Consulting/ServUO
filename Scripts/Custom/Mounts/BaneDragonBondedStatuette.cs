    ...
    public class BaneDragonBondedStatuette : BaseDragonEggStatuette
    {
        ...
        public override BaseCreature Summon
        {
            get
            {
                ...
                // Color roll: rare overrides only. 56% stays the natural 1175 from BaneDragon ctor.
                ...
                else if (roll < 1200) bd.Hue = 2048;                // 8% existing
                else if (roll < 2000) bd.Hue = 2206;                // 8% existing
                else if (roll < 2800) bd.Hue = 2216;                // 8% existing
                else if (roll < 3600) bd.Hue = 2210;                // 8% existing
                else if (roll < 4400) bd.Hue = 2228;                // 8% existing
                // else: natural 1175 from BaneDragon constructor (56%)
