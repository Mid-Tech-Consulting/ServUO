...
{ 
   public class WarpstoneAvatarMystic : Item
   { 
	    private int originalBodyHue; 
	    private int newBodyHue = 1920;
	    private int newBodyValue = 0x3CA;
		private Mobile m_Owner;

		[Constructable]
		public WarpstoneAvatarMystic() : base( 0x1870 ) 
		{   Weight = 0.10; 
			Hue = 1920;
			Name = "Warpstone [Avatar Mystic]"; 
			LootType = LootType.Blessed;
		} 

		public WarpstoneAvatarMystic( Serial serial ) : base( serial ) 
		{ 
		} 
