...
{ 
   public class WarpstoneDolphin : Item
   { 
	    private int originalBodyHue; 
	    private int newBodyHue = 00;
	    private int newBodyValue = 151;
		private Mobile m_Owner;

		[Constructable]
		public WarpstoneDolphin() : base( 0x1870 ) 
		{   Weight = 0.10; 
			Name = "Warpstone [Dolphin]"; 
			Hue = 1152;
			LootType = LootType.Blessed;
		} 

		public WarpstoneDolphin( Serial serial ) : base( serial ) 
		{ 
		} 
