...
{ 
   public class WarpstoneBigBeast : Item
   { 
	    private int originalBodyHue; 
	    private int newBodyHue = 0;
	    private int newBodyValue = 999;
		private Mobile m_Owner;

		[Constructable]
		public WarpstoneBigBeast() : base( 0x1870 ) 
		{   
			Weight = 0.10; 
			Name = "Warpstone [Big Beast]";
			Hue = 1152;
			LootType = LootType.Blessed;
		} 

		public WarpstoneBigBeast( Serial serial ) : base( serial ) 
		{ 
		} 
