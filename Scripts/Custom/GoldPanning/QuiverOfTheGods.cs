...
{
	public class QuiverOfTheGods : BaseQuiver
	{
		public override int LabelNumber{ get{ return 1075038; } } // Quiver of Rage

		[Constructable]
		public QuiverOfTheGods() : base()
		{
			Name = " Quiver Of The Gods";
			Hue = 1174;

			WeightReduction = 50;
			DamageIncrease = 50;

			int val = Utility.RandomList(5, 10);
                        switch ( Utility.Random( 54 ) )
			{
				...
				case 4: SkillBonuses.SetValues( 0, SkillName.ArmsLore, val ); break;
                                ...
                                case 6: SkillBonuses.SetValues( 0, SkillName.Mysticism, val ); break;
		...
		public QuiverOfTheGods( Serial serial ) : base( serial )
		{
		}
		...
		{
			chaos = direct = 0;
			phys = 20; fire = 20; cold = 20; pois = 20; nrgy = 20;
		}
