...
{ 
   public class WarpstoneFrostPixie : Item
   { 
	    private int originalBodyHue; 
	    private int newBodyHue = 1152;
	    private int newBodyValue = 128;
		private Mobile m_Owner;

		[Constructable]
		public WarpstoneFrostPixie() : base( 0x1870 ) 
		{   
			Weight = 0.10; 
			Name = "Warpstone [Frost Pixie]";
			Hue = 1152;
			LootType = LootType.Blessed;
		} 

		public WarpstoneFrostPixie( Serial serial ) : base( serial ) 
		{ 
		} 
