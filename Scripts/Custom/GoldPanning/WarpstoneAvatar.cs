// Created by Jadis
// Modified by Dawn - Admin of G�tterd�mmerung
...
{
   public class WarpstoneAvatar : Item
   {
	    private int originalBodyHue;
	    private int newBodyHue = 0x481;
	    private int newBodyValue = 0x3CA;
		private Mobile m_Owner;

		[Constructable]
		public WarpstoneAvatar() : base( 0x1870 )
		{   Weight = 0.10;
			Hue = 1152;
			Name = "Warpstone [Avatar]";
			LootType = LootType.Blessed;
		}

		public WarpstoneAvatar( Serial serial ) : base( serial )
		{
		}
