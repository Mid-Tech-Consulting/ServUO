...
namespace Server.Items
{
	...
	public class BrokenSandals : BaseShoes
	{

		[Constructable]
		public BrokenSandals() : base( 0x170d )
		{
                        //Name = "Broken Sandals [ULTRA RARE]";
			Name = "<BASEFONT COLOR=#A335EE>Broken Sandals [ULTRA RARE]</font>";
			Hue = 1179;
			Weight = 1.0;
			...
			//Attributes.BonusStam = 5;
                       ...
                       int val = Utility.RandomList(1,2,3,4,5);
		...
		public BrokenSandals( Serial serial ) : base( serial )
		{
		}
