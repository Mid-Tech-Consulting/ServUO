...
{ 
   public class WarpstoneFrostmare : Item
   { 
	    private int originalBodyHue; 
	    private int newBodyHue = 1152;
	    private int newBodyValue = 116;
		private Mobile m_Owner;

		[Constructable]
		public WarpstoneFrostmare() : base( 0x1870 ) 
		{   Weight = 0.10; 
			Name = "Warpstone [Frostmare]";
			Hue = 1152; 
			LootType = LootType.Blessed;
		} 

		public WarpstoneFrostmare( Serial serial ) : base( serial ) 
		{ 
		} 
