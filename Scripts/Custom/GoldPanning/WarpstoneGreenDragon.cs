...
{ 
   public class WarpstoneGreenDragon : Item
   { 
	    private int originalBodyHue; 
	    private int newBodyHue = 0x592;
	    private int newBodyValue = 0x3B;
		private Mobile m_Owner;

		[Constructable]
		public WarpstoneGreenDragon() : base( 0x1870 ) 
		{   Weight = 0.10; 
			Name = "Warpstone [Green Dragon]"; 
			Hue = 1152;
			LootType = LootType.Blessed;
		} 

		public WarpstoneGreenDragon( Serial serial ) : base( serial ) 
		{ 
		} 
