...
namespace Server.Engines.Plants
{
	...
	public class PlantTypeInfo
	{
		private static PlantTypeInfo[] m_Table = new PlantTypeInfo[]
		{
			...
			new PlantTypeInfo( 0x28DC, -5, 5,		PlantType.CommonGreenBonsai,	true, false, false, true,		PlantCategory.Common ),
			new PlantTypeInfo( 0x28DF, -5, 5,		PlantType.CommonPinkBonsai,		true, false, false, true,		PlantCategory.Common ),
			new PlantTypeInfo( 0x28DD, -5, 5,		PlantType.UncommonGreenBonsai,	true, false, false, true,		PlantCategory.Uncommon ),
			new PlantTypeInfo( 0x28E0, -5, 5,		PlantType.UncommonPinkBonsai,	true, false, false, true,		PlantCategory.Uncommon ),
			new PlantTypeInfo( 0x28DE, -5, 5,		PlantType.RareGreenBonsai,		true, false, false, true,		PlantCategory.Rare ),
			new PlantTypeInfo( 0x28E1, -5, 5,		PlantType.RarePinkBonsai,		true, false, false, true,		PlantCategory.Rare ),
			new PlantTypeInfo( 0x28E2, -5, 5,		PlantType.ExceptionalBonsai,	true, false, false, true,		PlantCategory.Exceptional ),
			new PlantTypeInfo( 0x28E3, -5, 5,		PlantType.ExoticBonsai,			true, false, false, true,		PlantCategory.Exotic ),
			new PlantTypeInfo( 0x0D25, 0, 0,		PlantType.Cactus,				false, false, false, true,		PlantCategory.Peculiar ),
			new PlantTypeInfo( 0x1A9A, 5, 10,		PlantType.FlaxFlowers,			false, true, false, true,		PlantCategory.Peculiar ),
			new PlantTypeInfo( 0x0C84, 0, 0,		PlantType.FoxgloveFlowers,		false, true, false, true,		PlantCategory.Peculiar ),
			new PlantTypeInfo( 0x1A9F, 5, -25,		PlantType.HopsEast,				false, false, false, true,		PlantCategory.Peculiar ),
			new PlantTypeInfo( 0x0CC1, 0, 0,		PlantType.OrfluerFlowers,		false, true, false, true,		PlantCategory.Peculiar ),
			new PlantTypeInfo( 0x0CFE, -45, -30,	PlantType.CypressTwisted,		false, false, false, true,		PlantCategory.Peculiar ),
			new PlantTypeInfo( 0x0C8F, 0, 0,		PlantType.HedgeShort,			false, false, false, true,		PlantCategory.Peculiar ),
			new PlantTypeInfo( 0x0CC8, 0, 0,		PlantType.JuniperBush,			true, false, false, true,		PlantCategory.Peculiar ),
			new PlantTypeInfo( 0x0C8E, -20, 0,		PlantType.SnowdropPatch,		false, true, false, true,		PlantCategory.Peculiar ),
			new PlantTypeInfo( 0x0CB7, 0, 0,		PlantType.Cattails,				false, false, false, true,		PlantCategory.Peculiar ),
			new PlantTypeInfo( 0x0CBE, -20, 0,		PlantType.PoppyPatch,			false, true, false, true,		PlantCategory.Peculiar ),
			new PlantTypeInfo( 0x0CC9, 0, 0,		PlantType.SpiderTree,			false, false, false, true,		PlantCategory.Peculiar ),
			new PlantTypeInfo( 0x0DC1, -5, 15,		PlantType.WaterLily,			false, true, false, true,		PlantCategory.Peculiar ),
			new PlantTypeInfo( 0x0CFB, -45, -30,	PlantType.CypressStraight,		false, false, false, true,		PlantCategory.Peculiar ),
			new PlantTypeInfo( 0x0DB8, 0, -20,		PlantType.HedgeTall,			false, false, false, true,		PlantCategory.Peculiar ),
			new PlantTypeInfo( 0x1AA1, 10, -25,		PlantType.HopsSouth,			false, false, false, true,		PlantCategory.Peculiar ),
